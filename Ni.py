...
def menu(my_name,my_id):
	...
	banner()
	sg = '# INFO AKUN ORANG SANGE'
	fx = mark(sg, style='green')
	sol().print(fx)
	print(k+'['+h+'•'+k+'] SI COLI : '+str(my_name))
	print(k+'['+h+'•'+k+'] ID SI COLI   : '+str(my_id))
	print(k+'['+h+'•'+k+'] IP SI COLI  : '+str(sh['origin']))
	io = '''[bold lightpurple][01] PUBLIC 	     [06] CRACK FROM FILES
...
[05] GROUP MEMBERS           [00] LOGOUT[bold purple]'''
	...
	cetak(nel(oi, title='[bold purple] • MENU COLI • [/bold purple]'))
...
def dump_publik():
	...
	try:
		...
		print(k+'['+h+'•'+k+'] JUMLAH KORBAN COLI : '+str(len(id)))
		setting()
	except requests.exceptions.ConnectionError:
...
def setting():
	...
	teks = '[01] NGENTOT JANDA(Berpengalaman)\n[02] NGENTOT PERAWAN(Lebih Legit)\n[03] NGENTOT BEBAS'
	tak = nel(teks, style='purple')
	cetak(nel(tak, title=' • ENTOT • '))
...
# WORDLIST
def passwrd():
	ler = '# NGOCOK DIMULAI, TEKAN CTRL+Z TO STOP'
